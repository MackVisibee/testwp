...
Tags: populate posts, random content, dummy content, gutenberg template, demo content, helper plugin, random tags, random publish date, posts with images, generate taxonomy terms
...
== Version history ==
4.2.3 - Tested up to 6.4.1, assets updates
4.2.2 - Tested up to 6.3.1, added the author option, separated extra from images, translation update
4.2.1 - Tested up to 6.2.2, added the icon in the admin post listing to differentiate generate from manually created posts
4.2.0 - Added post ID, post title, post excerpt, post featured image ID, and post featured image URL as options to be used in the Gutenberg template; fixed the menu overlay
4.1.1 - Tested up to 6.2
4.1.0 - Tested up to 6.1.1, added new patterns for random date, time, date & time, longitude, and latitude, fixed the saved groups reset on plugin deactivate
